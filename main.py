...
SISTEM_MESAJI_ICERIK_TEMPLATE = (
    ...
    "            \"urun\": \"Limonata\",\n"
    "            \"adet\": 2,\n"
    "            \"fiyat\": 75.00,      // SAYI (FLOAT) OLARAK\n"
    "            \"kategori\": \"Soğuk İçecekler\",\n"
    "            \"musteri_notu\": \"\"\n"
    "          }}\n"
    "        ],\n"
    "        \"toplam_tutar\": 150.00,  // SAYI (FLOAT) OLARAK\n"
    "        \"musteri_notu\": \"\",\n"
    "        \"konusma_metni\": \"Harika tercih! 2 adet Limonata (150.00 TL) sepetinize eklendi. Başka bir lezzet eklemek ister misiniz? 🍋\",\n"
    "        \"onerilen_urun\": null,\n"
    ...
    "     b. Ardından, **SADECE MENÜDEKİ** mevcut benzer kategoriden (eğer varsa ve ürün içeriyorsa) alternatifler sun (örn: 'Ancak dilerseniz menümüzdeki diğer bitki çaylarımızdan Adaçayı (XX TL) veya Ihlamur (YY TL) deneyebilirsiniz.' -> BU ÖRNEKTE ADAÇAYI VE IHLAMURUN MENÜDE OLDUĞU VARSAYILMIŞTIR. EĞER MENÜDE BU ÜRÜNLER YOKSA, ONLARI ÖNERME! Sadece menüde olanları öner.).\n"
    "     c. Aynı zamanda, menüde olan ve istenen diğer ürünleri (örn: '2 adet Sahlep (ZZ TL)') sepete ekleyebileceğini belirt.\n"
    "     d. Kullanıcıya ne yapmak istediğini sor (örn: 'Sahleplerinizi hazırlayalım mı? Yanında menümüzdeki başka bir çayımızdan denemek ister misiniz?').\n"
